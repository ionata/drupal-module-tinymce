...
/**
 * Defines CKEditor-based text editor for Drupal.
 *
 * @Editor(
 *   id = "ckeditor5plus",
...
class CKEditor extends EditorBase implements ContainerFactoryPluginInterface {
  ...
  public function getJSSettings(Editor $editor) {
    ...
    && !empty($settings['ckeditor_editor_settings'])
      ? $settings['ckeditor_editor_settings']
      : '{}';
  ...
  public function buildConfigurationForm(array $form, FormStateInterface $form_state) {
    ...
    $form['ckeditor_editor_settings'] = [
      '#type' => 'textarea',
      '#title' => $this->t('Editor settings'),
      '#default_value' => $settings['ckeditor_editor_settings'],
